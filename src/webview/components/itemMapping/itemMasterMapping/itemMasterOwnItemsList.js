...
const ItemMasterOwnItemsList = (props) => {
  const {
    c2code,
  ...
  const body2 = { c_c2code: c2code, c_list_type: 3, n_page: 0, n_limit: limit };
  useEffect(() => {
    const body = {
      c_c2code: c2code,
      c_list_type: 3,
  ...
  }, [blockItemMasterMapResult, confirmItemMasterMapResult]);
        ...
        <Table className="itemMapList itemMapListVTop" stickyHeader>
          <TableHead>
            <TableRow className="head noBorder">
              ...
              <TableCell width="30%">C-Square Master Attribute</TableCell>
...
export default ItemMasterOwnItemsList;
