...
import PlayButtonSVG from "../../../../assets/images/Play_icon.svg";
import VideoPreview from "../../../../assets/images/watch_the_video.png";
...
class NewVideo extends Component {
	...
	render() {
		return (
			...
			>
				<h2 className="h2 mr-b-16" data-aos-once="true" data-aos="fade-up">
					Want to know More ?
				</h2>
				<h4
