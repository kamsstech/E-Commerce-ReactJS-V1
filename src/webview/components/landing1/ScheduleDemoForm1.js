...
import "./ScheduleADemo/ScheduleADemo1.css";
...
const ScheduleDemoForm1 = (props) => {
	...
	const handleSubmit = () => {
		...
		if (inputs.c_name === "" || errors.c_name === true) {
			...
			// console.log(emailBody, "<<< Schedule emailBody ")
			ScheduleDemoEmailAction(emailBody);
			ScheduleDemoAction(body);
	...
	const handleCheckbox = (name) => (event) => {
		...
		// console.log(event.target.checked,"<<< checked item");
		setCheckList({
			...checkList,
	...
	useEffect(() => {
		// console.log(scheduledemoRequestResult,"<<< scheduledemoRequestResult")
		// console.log(scheduleDemoEmailResult,"<<< scheduleDemoEmailResult")

		
		if(scheduledemoRequestResult.statuscode === 0 && inputs.c_name !== ""){

			setRespModalOpen(true);
			setSuccessMsg(scheduledemoRequestResult.payload);
			setInputs({
				c_name: "",
			c_pincode: "",
			c_mobile_no: "",
			...
			// setSuccessMsg("");
		}else if(scheduledemoRequestResult.statuscode === 2 && inputs.c_name !== ""){

			setRespModalOpen(true);
			setErrMsg(scheduledemoRequestResult.error);
			setInputs({
				c_name: "",
			c_pincode: "",
			c_mobile_no: "",
		...
		else if(scheduledemoRequestResult.statuscode === 4 && inputs.c_name !== ""){
		...
		// if (scheduledemoRequestResult.error !== "") {
		//   setSuccessMsg("");
		//   setErrMsg(scheduledemoRequestResult.error);
		//   setRespModalOpen(true);
			
		// }
		// else if (scheduledemoRequestResult.statuscode === 0) {
		//   // setSuccessMsg("Your Request for product demo is accepted, soon you will be contacted!");
		//   setSuccessMsg(
		//     scheduledemoRequestResult.message
		//   );
		//   setRespModalOpen(true);
		//   setErrMsg("");
							...
							<Grid container spacing={0} className="mt-16 ask-for-demo">
								...
								<Grid item xs={12}>
									<div className="mr-16 text-right mr-b-24">
										...
										>
											{scheduledemoRequestResult && scheduledemoRequestResult.loading ? (
...
export default ScheduleDemoForm1;
