...
import QMarkAnimated from "../../../../assets/animation/Why-live-order.json";
...
class WhyLiveSection extends Component {
	...
	componentDidMount() {
		...
		if (window.location.hash === "#whyLive") {
			...
			setTimeout(() => elm.scrollIntoView(), 150);
		}
	}
		...
		return (
			<div className="WhyLiveSection MainContainer" id="whyLive">
				...
				<h4
					...
					data-aos-delay="0"
				>
					B2B online ordering platform connecting Buyers &amp; sellers <br/>
			which gives Overall solution.
				</h4>*/}
						<div className="MainContainer">
					<Grid item xs={12}>
						<div className="whyLiveSectionTitle text-center mb-lg-0">
							<h3
								data-aos-once="true"
								data-aos="fade-up"
								data-aos-delay="250"
					...
					<Grid container>
						<Grid item xs={3}>
							<div className="ml-16 mr-16">
								<div
									className="card mb-4 right-seller flex-fixed-height"
									data-aos="fade-up"
									data-aos-once="true"
									data-aos-delay="500"
								>
									<div className="card-body p-0">
										<div className="CardIconHolder SellerImg d-flex align-items-center justify-content-center">
										...
										<h6 className="h6 CardSubtitle">Find The Right Sellers</h6>
										<p className="body-copy">
											We help Buyers to find the right Sellers offering the best prices, within their geography.
										</p>
									</div>
								</div>
							</div>
						...
						<Grid item xs={3}>
							<div className="ml-16 mr-16 mr-t-40">
								<div
									className="card mb-4 mb-lg-0 centralized-tracking flex-fixed-height"
									data-aos="fade-up"
									data-aos-once="true"
									data-aos-delay="500"
								>
									<div className="card-body p-0">
										<div className="CardIconHolder TrackingImg d-flex align-items-center justify-content-center">
										...
										<h6 className="h6 CardSubtitle">Invoice Reconciliation</h6>
										<p className="body-copy">
											Invoice reconciliation is important for keeping accounting records updated &amp; avoid fraud.
										</p>
									</div>
								</div>
							</div>
						...
						<Grid item xs={3}>
							<div className="ml-16 mr-16">
								...
								>
									<div className="card-body p-0">
										<div className="CardIconHolder ReconciliatonImg d-flex align-items-center justify-content-center">
											{/* <img
										...
										<h6 className="h6 CardSubtitle">
											Centralised Tracking
										</h6>
										<p className="body-copy">
											End-to-end tracking  starting from order placement to delivery of product.
										</p>
									</div>
								</div>
							</div>
						...
						<Grid item xs={3}>
							<div className="ml-16 mr-16 mr-t-40">
								<div
									className="card manage-team flex-fixed-height"
									data-aos="fade-up"
									data-aos-once="true"
									data-aos-delay="500"
								>
									<div className="card-body p-0">
										<div className="CardIconHolder ManageTeamImg d-flex align-items-center justify-content-center">
										...
										<h6 className="h6 CardSubtitle">Manage Your Entire Team</h6>
										<p className="body-copy">
											Team management solution. Option to create teams &amp; branches and manage user rights.
										</p>
									</div>
								</div>
							</div>
