...
import WizardCircle from "./WizardCircle";
...
const AddBranch = (props) => {
	...
	const [inputs, setInputs] = useState({
		...
		c_drug_license_no1: "",
		c_druglicense_no2: "",
		c_drug_license_no1_expiry_date: "",
		c_gst_type: -100,
		c_gst_number: "",
		c_narcotic_no: "",
		c_status: "",
	...
	const [errors, setErrors] = useState({
		...
		d_card_exp: false,
		c_card_ifsc: false,
		c_drug_license_no1: false,
		c_druglicense_no2: false,
		c_drug_license_no1_expiry_date: false,
		c_gst_type: false,
		c_gst_number: false,
		c_narcotic_no: false,
		...
		c_pan_no: false,
		c_it_pan_no: false,
		c_electricity_bill: false,
		c_rent_agreement_no: false,
		c_partnership_deed: false,
	...
	const handleInputChange = (e) => {
		...
		//   setGstType(value);
		// }
		else if (name === "c_drug_license_no1" || name === "c_druglicense_no2") {
			if (value.length > 15) {
				value = value.slice(0, 15);
			} else {
				setInputs({ ...inputs, [name]: value });
			}
		} else if (name === "c_contact_person_name") {
			if (value.length > 16) {
				value = value.slice(0, 16);
			} else {
				setInputs({ ...inputs, [name]: value });
			}
		} else if (name === "c_address_no1" || name === "c_address_no2") {
			if (value.length > 20) {
	...
	const handleUpload = (event) => {
		...
		if (
			...
			if (name === "c_drug_license_no1_img") {
				setInputs({
					...inputs,
			...
			} else if (name === "c_electricity_bill_img") {
				setInputs({
					...inputs,
					[`${name}_name`]: imageUploadResult.payload.path,
					[name]: imageUploadResult.payload.path,
			...
			} else if (name === "c_partnership_deed_img") {
				setInputs({
					...inputs,
					[`${name}_name`]: imageUploadResult.payload.path,
					[name]: imageUploadResult.payload.path,
			...
			setErrMsg("Please Select Valid Imagessssss");
		}
	};
	...
	const clickHandleCancel = (event) => {
		...
		if (event === "c_dl1_img") {
			setInputs({ ...inputs, c_drug_license_no1_img: "" });
	...
	const handleBlur = (e) => {
		...
		// else if (name === "c_drug_license_no1") {
		//   if (value.length < 13) {
		//     setErrors({ ...errors, [name]: true });
		//   }
		//   if (value !== "" && inputs.c_drug_license_no1_img_name === "") {
		//     setErrors({ ...errors, [name]: true });
		//   }
		...
		// }
		else if (name === "c_address_no1" && value.length < 4) {
			setErrors({ ...errors, [name]: true });
		} else if (name === "c_address_no2" && value.length < 4) {
			setErrors({ ...errors, [name]: true });
		} else if (name === "c_contact_person_name") {
	...
	function handleDrugExpiryDate(date) {
		let selDate = "";
		let currDate = "";
		setErrors({ ...errors, c_drug_license_no1_expiry_date: false });
		if (date !== null) {
			...
			if (currDate === selDate) {
				...
				setInputs({ ...inputs, c_drug_license_no1_expiry_date: selDate });
	...
	const handleSubmit = () => {
		if (inputs.c_firm_name === "" || errors.c_firm_name === true) {
		...
		else if(inputs.c_contact_person_name === "" || errors.c_contact_person_name === true){
			setErrors({ ...errors, c_contact_person_name: true });
		}
		else if(inputs.c_address_no1 === "" || errors.c_address_no1 === true){
			setErrors({ ...errors, c_address_no1: true });
		}
		else if(inputs.c_address_no2 === "" || errors.c_address_no2 === true){
			setErrors({ ...errors, c_address_no2: true });
		}
		// else if (
		//   inputs.c_drug_license_no1 === "" ||
		//   errors.c_drug_license_no1 === true
		// ) {
		//   setErrors({ ...errors, c_drug_license_no1: true });
		// } else if (errors.c_druglicense_no2 === true) {
		//   setErrors({ ...errors, c_druglicense_no2: true });
		// } else if (
		//   inputs.c_drug_license_no1_expiry_date === "" ||
		//   errors.c_drug_license_no1_expiry_date === true
		// ) {
		//   setErrors({ ...errors, c_drug_license_no1_expiry_date: true });
		// } 
		else if (inputs.c_gst_type === -100 || errors.c_gst_type === true) {
			setErrors({ ...errors, c_gst_type: true });
		} 
		else if (inputs.c_gst_number === "" || errors.c_gst_number === true) {
			setErrors({ ...errors, c_gst_number: true });
		} 
		// else if (
		//   inputs.c_contact_person_name === "" ||
		//   errors.c_contact_person_name === true
		// ) {
		//   setErrors({ ...errors, c_contact_person_name: true });
		// } else if (
		//   inputs.c_address_no1 === "" ||
		//   errors.c_address_no1 === true
		// ) {
		//   setErrors({ ...errors, c_address_no1: true });
		// } else if (
		//   inputs.c_address_no2 === "" ||
		//   errors.c_address_no2 === true
		// ) {
		//   setErrors({ ...errors, c_address_no2: true });
		// } else if (inputs.c_pincode === "" || errors.c_pincode === true) {
		//   setErrors({ ...errors, c_pincode: true });
		...
		// }
			...
			//   if (
			//     entry[0] === "c_drug_license_no1_img_name" ||
			...
			const body = {
				...
				c_drug_license_no1: inputs.c_drug_license_no1,
				c_drug_license_no1_img: inputs.c_drug_license_no1_img,
				...
				c_electricity_bill: inputs.c_electricity_bill,
				c_electricity_bill_img: inputs.c_electricity_bill_img,
				c_rent_agreement: inputs.c_rent_agreement_no,
				c_rent_agreement_img: inputs.c_rent_agreement_no_img,
				c_partnership_deed: inputs.c_partnership_deed,
				c_partnership_deed_img: inputs.c_partnership_deed_img,
				...
				c_contact_person_name: inputs.c_contact_person_name,
				...
				c_area_code: value2.c_area_code,
				c_area_name: value2.c_area_name,
				c_type: "B",
				c_firm_img: inputs.c_image_url,
			};

			if(inputs.c_drug_license_no1_expiry_date !== '')
			{
					body['c_drug_license_no1_expiry_date']=inputs.c_drug_license_no1_expiry_date;
					// body['c_drug_license_no2_expiry_date']=inputs.c_drug_license_no1_expiry_date;
					// body['c_drug_license_no3_expiry_date']=inputs.c_drug_license_no1_expiry_date;
			}
		 
			if(match.params.branchId){
				AddBranchAction(body,match.params.branchId);
			}else{
	...
	// 				if (entry[0] === "c_drug_license_no1_img") {
	// 					temp[entry[0]] = entry[1];
	// 					temp["c_drug_license_no1_img_name"] = entry[1].substring(
	...
	// 						entry[1].length
	// 					);
	// 				} else if (entry[0] === "c_drug_license_no1_expiry_date") {
	...
	useEffect(() => {
		if (match.params.branchId) {
			if (getBranchListUsersResult.error === "") {
				let temp = { ...inputs };

				Object.entries(getBranchListUsersResult.payload).map((entry) => {
					if (entry[0] === "c_drug_license_no1_img") {
						temp[entry[0]] = entry[1];
						temp["c_drug_license_no1_img_name"] = entry[1].substring(
							entry[1].lastIndexOf("/") + 1,
			...
			setErrorMsg(getBranchListUsersResult.error);
		}
	}, [getBranchListUsersResult]);
	...
	return (
		<div>
			<ImageView
				...
				imgUrl={inputs.c_drug_license_no1_img}
			/>
			<ImageView
				open={openImgViewD2}
			...
			<ImageView
				...
				imgUrl={inputs.c_electricity_bill_img}
			/>
			<ImageView
				open={openImgViewRA}
			...
			<ImageView
				...
				imgUrl={inputs.c_partnership_deed_img}
			/>
			<ImageView
				open={openImgViewBS}
			...
			<div className="profile-title-sec ml-16">
				<div>
					<h4 className="profile-title mr-b-8">Branch Management</h4>
						...
						<Grid item xs={4}>
							<div className="ml-16">
								<TextField
									...
									helperText={errors.c_firm_name && "Not a valid Store/Firm Name"}
									margin="normal"
									variant="outlined"
								...
								<>
									...
									<Grid container spacing={0}>
										<Grid item xs={4}>
											<div className="ml-16">
												<TextField
													name="c_drug_license_no1"
													value={inputs.c_drug_license_no1}
													onChange={(e) => handleInputChange(e)}
													error={errors.c_drug_license_no1}
													onBlur={(e) => handleBlur(e)}
													autoComplete="new-password"
													helperText={
														errors.c_drug_license_no1 &&
														inputs.c_drug_license_no1_img_name === "" &&
													...
													InputProps={{
														...
														endAdornment: (
															<InputAdornment position="end">
																...
																<input
																	type="file"
																	name="c_drug_license_no1_img"
																	id="c_drug_license_no1"
											...
											<div className="ml-16">
												<MuiPickersUtilsProvider utils={DateFnsUtils}>
													<DatePicker
														...
														value={inputs.c_drug_license_no1_expiry_date}
														onChange={handleDrugExpiryDate}
														error={errors.c_drug_license_no1_expiry_date}
														className="auth-input"
										...
										<Grid item xs={4}>
											<div className="ml-16">
												...
												<TextField
													...
													onBlur={(e) => handleBlur(e)}
													helperText={
														errors.c_gst_number && "Not a valid GST number"
													}
													margin="normal"
													variant="outlined"
								...
								<Grid container spacing={0}>
											...
											{inputs.c_tan_no_img && (
												<div className="display-flex">
													...
													>
														...
														{/* <span>{inputs.c_drug_license_no1_img_name}</span> */}
													</h4>
													<h4
														className="profile-upload uploaded-imagename float-right"
									...
									<Grid item xs={4}>
										<div className="ml-16">
											...
											<TextField
												name="c_electricity_bill"
												value={inputs.c_electricity_bill}
												onChange={(e) => handleInputChange(e)}
												error={errors.c_electricity_bill}
												onBlur={(e) => handleBlur(e)}
												autoComplete="new-password"
												helperText={
													errors.c_electricity_bill &&
													inputs.c_electricity_bill_img_name === "" &&
											...
											{inputs.c_electricity_bill_img && (
												<div className="display-flex">
													<h4
														className="profile-upload uploaded-imagename"
														onClick={() => setOpenImgViewEB(true)}
													>
														<span>{inputs.c_electricity_bill_img}</span>
														{/* <span>{inputs.c_drug_license_no1_img_name}</span> */}
													</h4>
													<h4
														className="profile-upload uploaded-imagename float-right"
									...
									<Grid item xs={4}>
										<div className="ml-16">
											...
											<TextField
												name="c_partnership_deed"
												value={inputs.c_partnership_deed}
												onChange={(e) => handleInputChange(e)}
												error={errors.c_partnership_deed}
												onBlur={(e) => handleBlur(e)}
												autoComplete="new-password"
												helperText={
													errors.c_partnership_deed &&
													inputs.c_partnership_deed_img_name === "" &&
												...
												InputProps={{
													...
													endAdornment: (
														<InputAdornment position="end">
															...
															<input
																type="file"
																name="c_partnership_deed_img"
																id="c_partnership_deed"
																accept="image/jpeg, image/png, image/jpg, image/webp"
																onChange={(e) => handleUpload(e)}
																multiple={false}
															/>
											...
											{inputs.c_partnership_deed_img && (
												<div className="display-flex">
													<h4
														className="profile-upload uploaded-imagename"
														onClick={() => setOpenImgViewPD(true)}
													>
														<span>{inputs.c_partnership_deed_img}</span>
														{/* <span>{inputs.c_drug_license_no1_img_name}</span> */}
													</h4>
													<h4
														className="profile-upload uploaded-imagename float-right"
									...
									<Grid container spacing={0}>
										<Grid item xs={4}>
											<div className="ml-16">
												<TextField
													...
													value={inputs.c_contact_person_name}
													onChange={(e) => handleInputChange(e)}
													error={errors.c_contact_person_name}
													onBlur={(e) => handleBlur(e)}
													helperText={
														errors.c_contact_person_name && "Not a valid name"
													}
													margin="normal"
													variant="outlined"
										...
										<Grid item xs={4}>
											<div className="ml-16">
												<TextField
													...
													helperText={
														errors.c_address_no1 && "Not a valid address"
													}
													margin="normal"
													variant="outlined"
										...
										<Grid item xs={4}>
											<div className="ml-16">
												<TextField
													name="c_address_no2"
													value={inputs.c_address_no2}
													onChange={(e) => handleInputChange(e)}
													onBlur={(e) => handleBlur(e)}
													error={errors.c_address_no2}
													helperText={
														errors.c_address_no2 && "Not a valid address"
													}
													margin="normal"
													variant="outlined"
...
<TextField
                            ...
                            // placeholder={inputs.c_state_name}
                            onChange={(e) => handleInputChange(e)}
                            error={errors.c_state_name}
                            onBlur={(e) => handleBlur(e)}
                            helperText={
                              errors.c_state_name && "Not a valid State"
                            }
                            margin="normal"
                            variant="outlined"
                            placeholder="State *"
                          ...
                          />
                            ...
                            // placeholder={inputs.c_city_name}
                            onChange={(e) => handleInputChange(e)}
                            error={errors.c_city_name}
                            onBlur={(e) => handleBlur(e)}
                            helperText={
                              errors.c_city_name && "Not a valid City"
                            }
                            margin="normal"
                            variant="outlined"
                            placeholder="City *"
...
<Autocomplete
                            ...
                            renderInput={(params) => (
                              <TextField
                                ...
                                helperText={
                                  errors.c_area_name && "Not a valid Area"
                                }
                                onChange={(e) => handleChanges(e)}
                                // onBlur={(e) => handleBlur(e)}
                                variant="outlined"
                          ...
                          />
							...
							<div className="align-right">
								...
								<Button
									...
									onClick={handleBack}
									className="previous-btn mr-r-12"
								>
									Previous
								</Button>
								{activeStep === steps.length - 1 ? (
									<Button
										...
										disabled={
											inputs.c_contact_person_name === "" || errors.c_contact_person_name === true ||
											inputs.c_address_no1 === "" || errors.c_address_no1 === true ||
											inputs.c_address_no2 === "" || errors.c_address_no2 === true ||
											inputs.c_pincode === "" || errors.c_pincode === true ||
											inputs.c_state_name === "" || errors.c_state_name === true ||
											inputs.c_city_name === "" || errors.c_city_name === true 
											// inputs.c_area_name === "" || errors.c_area_name === true 
										}
									>
										Finish
									</Button>
									...
									<Button
										...
										onClick={handleNext}
										disabled={
											inputs.c_firm_name === "" || errors.c_firm_name === true ||
											inputs.c_pincode === "" || errors.c_pincode === true ||
											inputs.c_drug_license_no1 === "" || errors.c_drug_license_no1 === true ||
											inputs.c_drug_license_no1_expiry_date === "" || errors.c_drug_license_no1_expiry_date === true ||
											inputs.c_gst_type === "" || errors.c_gst_type === true ||
