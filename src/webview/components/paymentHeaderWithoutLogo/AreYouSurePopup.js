		...
		<div>
			...
			>
				<DialogContent className="text-center">
						...
						<p className="custompp">You want to discontinue the payment process.</p>
						<div className="mr-t-12 pd-b-16">
								<Button variant="outlined" className="cancel mr-r-12" color="primary" onClick={handleClose}>Cancel</Button>
