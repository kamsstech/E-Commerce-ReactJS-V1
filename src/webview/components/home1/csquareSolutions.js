...
import { StateListEntity, DemoRequestInputEntity, DemoRequestEntity } from "../../../common/model";
...
const CSquareSolutions = (props) => {
  const {CityListAction,cityListResult,submitDemoRequestAction,demoRequestResult} = props;
    ...
    <div>
      ...
      <Slider {...settings} className="advertisements-slide">
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num1" style={{ backgroundImage: `url(${SolutionImg1})`}}>
              ...
              {/* <Button
                ...
                onClick={()=>{openDemoForm("Pharmsoft","sfa360")}}
            ...
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num2" style={{ backgroundImage: `url(${SolutionImg2})` }}>
                ...
                {/* <Button
                  ...
                  color="primary"
                  className="home-solution-getbtn"
                  onClick={()=>{openDemoForm("Ecogreen","ecogreen")}}
                >
                  Ask for Demo
                </Button> */}
              </div>
            ...
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num3" style={{ backgroundImage: `url(${SolutionImg3})` }}>
                ...
                {/* <Button
                  ...
                  color="primary"
                  className="home-solution-getbtn"
                  onClick={()=>{openDemoForm("Pharm Assist","pharmassist")}}
            ...
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num4" style={{ backgroundImage: `url(${EcoExpress})` }}>
                ...
                {/* <Button
                  ...
                  color="primary"
                  className="home-solution-getbtn"
                  onClick={()=>{openDemoForm("Pharm Assist","ecogreenexpress")}}
            ...
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num5" style={{ backgroundImage: `url(${Checklist})` }}>
              {/* style={{ backgroundImage: `url(${Checklist})` }} */}
                  <img src={PharmWholesaleLogo} alt="pharfsoft-wholesale" />
                <h4>
                  Grow Your<span className="orange"> Wholesale</span> <br />
                  Business
                </h4>
                <p>
                Manage your Sales, Purchase,<br />
                Inventory and Accounts<br />
                  easily. 
                  <br />
                </p>
                {/* <Button variant="contained" color="primary" className="home-solution-getbtn" onClick={()=>{openDemoForm("Pharm Assist","liveconnect")}}>Ask for Demo</Button> */}
              </div>
            </div>
            
            <div className="home-solutions-sec-main">
              <div className="home-solutions-sec num5" style={{ backgroundImage: `url(${PharmWow})` }}>
                <img src={PharmWowLogo} alt="PALogo" />
                <h4>
                  Manage Your<span className="orange"> Retail</span> <br />
                  Business
                </h4>
                <p>
                  Helps in "Several Management" <br />
      ...
      <ScheduleDemoForm demoFor={heading} open={open} handleClose={handleClose} productValue={productValue} CityListAction={CityListAction} cityListResult={cityListResult} submitDemoRequestAction={submitDemoRequestAction} demoRequestResult={demoRequestResult}/>
