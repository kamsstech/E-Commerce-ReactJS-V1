...
import VariationsListPage from "./VariationsListPage";
// import "./css/ProfileStyles.css";

export const VariationsPage = (props) => {
	const {
				...
				<Grid container spacing={0}>
					...
					<Grid item xs={9}>
						<div className="myprofile-box border-botttom-none">
							<VariationsListPage
								VariationsListPageAction={VariationsListPageAction}
								variationsListPageResult={variationsListPageResult}
							/>
						</div>
					</Grid>
				</Grid>
