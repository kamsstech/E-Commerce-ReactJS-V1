            ...
            return (
              <div key={index}>
                <div className="image-single">
                  ...
                  <img src={injectable} alt="Item" className="singleImg" />
                  
                  {/* {this.props.showProductDetails == true ? (
                    <div
                      className="shortbook_icon-sec"
                      onClick={(prevState) => {
                      ...
                      {this.state.iconColor ? (
                        <Tooltip title="Shortbook" TransitionComponent={Zoom}>
                          <img
                            ...
                            alt="shortbook_color_icon"
                            onClick={() => {
                              setTimeout(() => {
                                this.handleShortBookRemoved(
                                  GrowTransition,
                                  item.c_item_name,
                                  item.c_item_code
                                );
