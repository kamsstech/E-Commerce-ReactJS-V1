...
const Coupon = () => {
    ...
    return (
        <div className="chooseDelivery-coupon">
                    ...
                    <TextField
                        ...
                        InputProps={{
                            ...
                            endAdornment: <InputAdornment position="start" onClick={handleToggle}>
                                ...
                                <span className="delivery-charge-text remove">Remove</span>
                            </InputAdornment>
                        }}
                    />
 {/* remove option in coupons and below toggle is commented and use while integration */}
                    {/* {toggle &&
                        ...
                        <span className="coupons-status"> Yay! You've Successfully Applied 2 coupons </span>
                </div>
            </div>
        </div>
    )
